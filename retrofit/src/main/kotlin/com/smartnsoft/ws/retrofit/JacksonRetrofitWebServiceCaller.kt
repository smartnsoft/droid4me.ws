 ...
 * @since 2018.03.26
 */
abstract class JacksonRetrofitWebServiceCaller<API>(api: Class<API>, baseUrl: String, connectTimeout: Long = CONNECT_TIMEOUT, readTimeout: Long = READ_TIMEOUT, writeTimeout: Long = WRITE_TIMEOUT, cacheSize: Long = CACHE_SIZE, defaultCachePolicy: CachePolicy = CachePolicy.ONLY_NETWORK, defaultCacheRetentionTimeInSeconds: Int? = null,  defaultAllowedTimeExpiredCacheInSeconds: Int? = null) :
    RetrofitWebServiceCaller<API>(api, baseUrl, connectTimeout, readTimeout, writeTimeout, cacheSize, defaultCachePolicy, defaultCacheRetentionTimeInSeconds, defaultAllowedTimeExpiredCacheInSeconds, arrayOf(JacksonConverterFactory.create(), ScalarsConverterFactory.create()))
{
